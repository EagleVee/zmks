 ...
 * give-up timer has elapsed and BLE reports itself unavailable.  Lets a fallback
 * transport schedule its own availability only after BLE has actually concluded,
 * rather than at raw disconnect time. */
