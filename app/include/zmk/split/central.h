...
#define ESB_PERIPHERAL_COUNT CONFIG_ZMK_SPLIT_ESB_CENTRAL_PERIPHERALS
#else
#define ESB_PERIPHERAL_COUNT 0
#endif

#define ZMK_SPLIT_CENTRAL_PERIPHERAL_COUNT                                                         \
    MAX(MAX(BLE_PERIPHERAL_COUNT, WIRED_PERIPHERAL_COUNT), ESB_PERIPHERAL_COUNT)
